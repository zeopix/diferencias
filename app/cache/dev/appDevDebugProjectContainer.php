...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getFosFacebook_ApiService()
    {
        ...
        return $this->services['fos_facebook.api'] = new \FOS\FacebookBundle\Facebook\FacebookSessionPersistence(array('appId' => 123456879, 'secret' => 's3cr3t', 'cookie' => true, 'domain' => NULL), $this->get('session'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'fos_facebook.app_id' => 123456879,
            'fos_facebook.secret' => 's3cr3t',
