...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'mii_game_entrada_index');
            }
            return array (  '_controller' => 'Mii\\GameBundle\\Controller\\EntradaController::indexAction',  '_route' => 'mii_game_entrada_index',);
        }
